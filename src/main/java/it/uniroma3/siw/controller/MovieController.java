...
public class MovieController {
	...
	public String setDirectorToMovie(@PathVariable("directorId") Long directorId, @PathVariable("movieId") Long movieId, Model model) {
		model.addAttribute("movie", this.movieService.setDirectorToMovie(movieId, directorId));
		return "admin/formUpdateMovie.html";
	}
...
//		model.addAttribute("user", credentials.getUser());
	...
	public String updateActors(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("actorsToAdd", this.movieService.actorsToAdd(id));
		model.addAttribute("movie", this.movieService.findById(id));
	...
	public String addActorToMovie(@PathVariable("actorId") Long actorId, @PathVariable("movieId") Long movieId, Model model) {
		...
		model.addAttribute("movie", this.movieService.addActorToMOvie(movieId, actorId));
	...
	public String removeActorFromMovie(@PathVariable("actorId") Long actorId, @PathVariable("movieId") Long movieId, Model model) {
		...
		model.addAttribute("movie", this.movieService.removeActorFromMovie(movieId, actorId));
		model.addAttribute("actorsToAdd", actorsToAdd);
	...
	@GetMapping("/admin/eliminaRecensione/{movieId}/{recensioneId}")
	public String eliminaRecensione(@PathVariable("movieId") Long movieId, @PathVariable("recensioneId") Long recensioneId, Model model) {
		model.addAttribute("movie", this.movieService.deleteRecensione(movieId, recensioneId));
		return "admin/movieAdmin.html";
	}
